...
public class CameraController : MonoBehaviour
{
    ...
    [SerializeField] private float doubleClickTimeThreshold = 0.2f;
    ...
    private void ChangeCameraPos(Vector2 direction, bool isArrow = false)
    {
        ...
        direction *= Time.deltaTime * arrowSpeed;
    ...
    private void DoubleClickChangeTarget()
    {
        ...
        if (_isDoubleClickFix && _time >= doubleClickTimeThreshold)
        {
        ...
        {
            _isDoubleClick = _time <= doubleClickTimeThreshold;
            _time = 0f;
        }
